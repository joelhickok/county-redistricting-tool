                ...
                <div class="relative h-full flex flex-col py-6 bg-white shadow-xl overflow-y-scroll">
                    ...
                    <!--
                      ...
                      Leaving: "ease-in-out duration-500"
                        ...
                        To: "opacity-0"
                    -->
                    <div class="w-full bg-gray-500 flex justify-content-end">
                        <div class="bg-red-200">
                            <button type="button"
                                    class="bg-white rounded-md text-black hover:text-black focus:outline-none focus:ring-2 focus:ring-black">
